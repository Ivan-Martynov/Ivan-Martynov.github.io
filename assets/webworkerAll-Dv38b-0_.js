import { E as _, U as pt, T as xe, a as gt, d as G, v as z, D as oe, n as K, b as P, c as R, M, F as mt, f as xt, w as W, g as se, h as D, R as ie, I as _t, i as I, j as U, k as E, B as ke, l as k, P as bt, G as de, m as le, o as Ae, p as L, q as A, s as yt, S as N, t as Q, u as v, x as vt, y as ce, z as ne, V as $, A as he, H as Tt, J as wt, K as St, L as Ge, N as Ct, O as ze, Q as He, W as Bt, X as De, Y as Pt, Z as Rt, _ as Mt, $ as Ft, a0 as Ut, a1 as kt, a2 as At, a3 as Gt, a4 as Oe, e as w, a5 as zt, __tla as __tla_0 } from "./index-C8JEGCcJ.js";
let __tla = Promise.all([
    ...
    class Dt {
        ...
        getOptimalCanvasAndContext(e, t, r = 1) {
            e = Math.ceil(e * r - 1e-6), t = Math.ceil(t * r - 1e-6), e = K(e), t = K(t);
            const s = (e << 17) + (t << 1);
        ...
        returnCanvasAndContext(e) {
            ...
            e.context.clearRect(0, 0, r, s), this._canvasPool[i].push(e);
        }
        clear() {
            this._canvasPool = {};
        }
    }
    const O = new Dt, _e = 1e5;
    function q(a, e, t, r = 0) {
        ...
        if (a.fill) {
            if (a.fill instanceof mt) {
                const s = a.fill, i = e.createPattern(s.texture.source.resource, "repeat"), n = s.transform.copyTo(M.shared);
                return n.scale(s.texture.frame.width, s.texture.frame.height), i.setTransform(n), i;
            } else if (a.fill instanceof xt) {
                const s = a.fill, i = s.type === "linear", n = s.textureSpace === "local";
                let o = 1, d = 1;
                n && t && (o = t.width + r, d = t.height + r);
                let c, h = !1;
                if (i) {
                    const { start: l, end: f } = s;
                    c = e.createLinearGradient(l.x * o, l.y * d, f.x * o, f.y * d), h = Math.abs(f.x - l.x) < Math.abs((f.y - l.y) * .1);
                } else {
                    const { center: l, innerRadius: f, outerCenter: p, outerRadius: u } = s;
                ...
                if (h && n && t) {
                    ...
                    for(let f = 0; f < t.lines.length; f++){
                        ...
                        s.colorStops.forEach((u)=>{
                            ...
                            c.addColorStop(Math.floor(g * _e) / _e, R.shared.setValue(u.color).toHex());
                        });
                    }
                } else s.colorStops.forEach((l)=>{
                    c.addColorStop(l.offset, R.shared.setValue(l.color).toHex());
                });
                return c;
            }
        } else {
            const s = e.createPattern(a.texture.source.resource, "repeat"), i = a.matrix.copyTo(M.shared);
            return i.scale(a.texture.frame.width, a.texture.frame.height), s.setTransform(i), s;
        }
        return W("FillStyle not recognised", a), "red";
    }
    function Ee(a) {
        if (a === "") return [];
        typeof a == "string" && (a = [
        ...
        for(let t = 0, r = a.length; t < r; t++){
            ...
            if (Array.isArray(s)) {
                ...
                if (n < i) throw new Error("[BitmapFont]: Invalid character range.");
                for(let o = i, d = n; o <= d; o++)e.push(String.fromCharCode(o));
    ...
    const Le = class Ve extends Ht {
        ...
        ensureCharacters(e) {
            ...
            let f = 0, p = !1;
            const u = s.width / this.resolution, g = s.height / this.resolution;
            for(let m = 0; m < t.length; m++){
                const x = t[m], b = D.measureText(x, o, s, !1);
                b.lineHeight = b.height;
                const T = b.width * h, S = Math.ceil((o.fontStyle === "italic" ? 2 : 1) * T), C = b.height * h, F = S + l * 2, B = C + l * 2;
                if (p = !1, x !== `
` && x !== "\r" && x !== "	" && x !== " " && (p = !0, f = Math.ceil(Math.max(B, f))), d + F > u && (c += f, f = B, d = 0, c + f > g)) {
                    n.update();
                    const H = this._nextPage();
                    s = H.canvasAndContext.canvas, i = H.canvasAndContext.context, n = H.texture.source, c = 0;
                }
                const y = T / h - (o.dropShadow?.distance ?? 0) - (o._stroke?.width ?? 0);
                if (this.chars[x] = {
                    id: x.codePointAt(0),
                    ...
                    this._drawGlyph(i, b, d + l, c + l, h, o);
                    const H = n.width * h, V = n.height * h, J = new ie(d / H * n.width, c / V * n.height, F / H * n.width, B / V * n.height);
            ...
            n.update(), this._currentX = d, this._currentY = c, this._skipKerning && this._applyKerning(t, i);
        }
        get pageTextures() {
            return G(z, "BitmapFont.pageTextures is deprecated, please use BitmapFont.pages instead."), this.pages;
        }
        _applyKerning(e, t) {
            ...
            for(let s = 0; s < e.length; s++){
                ...
                for(let n = 0; n < this._currentChars.length; n++){
                    ...
                    let d = r[i];
                    d || (d = r[i] = t.measureText(i).width);
                    let c = r[o];
                    c || (c = r[o] = t.measureText(o).width);
                    let h = t.measureText(i + o).width, l = h - (d + c);
                    l && (this.chars[i].kerning[o] = l), h = t.measureText(i + o).width, l = h - (d + c), l && (this.chars[o].kerning[i] = l);
                }
            }
        }
        _nextPage() {
            this._currentPageIndex++;
            const e = this.resolution, t = O.getOptimalCanvasAndContext(this._textureSize, this._textureSize, e);
            this._setupContext(t.context, this._style, e);
            const r = e * (this.baseRenderedFontSize / this.baseMeasurementFontSize), s = new P({
                source: new _t({
                    resource: t.canvas,
                    resolution: r,
        ...
        _setupContext(e, t, r) {
            ...
            if (s && (e.lineWidth = i, e.lineJoin = s.join, e.miterLimit = s.miterLimit, e.strokeStyle = q(s, e)), t._fill && (e.fillStyle = q(t._fill, e)), t.dropShadow) {
        ...
        _drawGlyph(e, t, r, s, i, n) {
            const o = t.text, d = t.fontProperties, h = (n._stroke?.width ?? 0) * i, l = r + h / 2, f = s - h / 2, p = d.descent * i, u = t.lineHeight * i;
    ...
    function $e(a, e, t, r) {
        ...
        const d = {
            ...
            for(let m = 0; m < d.index; m++){
                ...
                i.chars.push(u.chars[m]), i.charPositions.push(x + g);
            }
            i.width += u.width, o = !1, d.width = 0, d.index = 0, d.chars.length = 0;
        }, h = ()=>{
            let u = i.chars.length - 1;
            if (r) {
                let g = i.chars[u];
                for(; g === " ";)i.width -= t.chars[g].xAdvance, g = i.chars[--u];
            }
            s.width = Math.max(s.width, i.width), i = {
                ...
                spaceWidth: 0,
                spacesIndex: []
            }, o = !0, s.lines.push(i), s.height += t.lineHeight;
        ...
        for(let u = 0; u < a.length + 1; u++){
            ...
            if (/(?:\s)/.test(g) || g === "\r" || g === `
` || m) {
                if (!o && e.wordWrap && i.width + d.width - f > p ? (h(), c(d), m || i.charPositions.push(0)) : (d.start = i.width, c(d), m || i.charPositions.push(0)), g === "\r" || g === `
`) i.width !== 0 && h();
                else if (!m) {
                    const C = x.xAdvance + (x.kerning[n] || 0) + f;
                    i.width += C, i.spaceWidth = C, i.spacesIndex.push(i.charPositions.length), i.chars.push(g);
                }
            } else {
        ...
        return h(), e.align === "center" ? Ot(s) : e.align === "right" ? Wt(s) : e.align === "justify" && It(s), s;
    }
    function Ot(a) {
    ...
    function It(a) {
        ...
        for(let t = 0; t < a.lines.length; t++){
            ...
            for(let h = 0; h < r.charPositions.length; h++)h === i && (i = r.spacesIndex[s++], n += c), r.charPositions[h] += n;
        }
    }
    let Y = 0;
    class Et {
        ...
        getFont(e, t) {
            ...
            if (!U.has(r)) {
                ...
                Y++, Y > 50 && W("BitmapText", `You have dynamically created ${Y} bitmap fonts, this can be inefficient. Try pre installing your font styles using \`BitmapFont.install({name:"style1", style})\``), n.once("destroy", ()=>{
                    Y--, U.remove(r);
                }), U.set(r, n);
            }
            const i = U.get(r);
        ...
        install(...e) {
            ...
            const s = t.style, i = s instanceof I ? s : new I(s), n = i._fill.fill !== null && i._fill.fill !== void 0, o = new be({
                style: i,
                overrideFill: n,
    ...
    class Xe {
        ...
        push(e) {
            ...
            const i = s.bounds;
            if (e.renderables ? Vt(e.renderables, i) : e.filterEffect.filterArea ? (i.clear(), i.addRect(e.filterEffect.filterArea), i.applyMatrix(e.container.worldTransform)) : e.container.getFastGlobalBounds(!0, i), e.container) {
            ...
            let o = 1 / 0, d = 0, c = !0, h = !1, l = !1, f = !0;
            for(let p = 0; p < r.length; p++){
                const u = r[p];
                if (o = Math.min(o, u.resolution === "inherit" ? n._resolution : u.resolution), d += u.padding, u.antialias === "off" ? c = !1 : u.antialias === "inherit" && c && (c = n.antialias), u.clipToViewport || (f = !1), !!!(u.compatibleRenderers & t.type)) {
                    l = !1;
                    break;
                }
                if (u.blendRequired && !(t.backBuffer?.useBackBuffer ?? !0)) {
                    W("Blend filter requires backBuffer on WebGL renderer to be enabled. Set `useBackBuffer: true` in the renderer options."), l = !1;
                    break;
                }
            ...
            if (f) {
                ...
                i.fitBounds(0, p.width / u, 0, p.height / u);
            }
            if (i.scale(o).ceil().scale(1 / o).pad(d | 0), !i.isPositive) {
                s.skip = !0;
                return;
            }
            s.skip = !1, s.bounds = i, s.blendRequired = h, s.container = e.container, s.filterEffect = e.filterEffect, s.previousRenderSurface = t.renderTarget.renderSurface, s.inputTexture = k.getOptimalTexture(i.width, i.height, o, c), t.renderTarget.bind(s.inputTexture, !0), t.globalUniforms.push({
                offset: i
            });
        }
        pop() {
            ...
            if (e.renderTarget.finishRenderPass(), t.blendRequired) {
                ...
                i = this.getBackTexture(d, s, o);
            }
            t.backTexture = i;
            const n = t.filterEffect.filters;
            if (this._globalFilterBindGroup.setResource(r.source.style, 2), this._globalFilterBindGroup.setResource(i.source, 3), e.globalUniforms.pop(), n.length === 1) n[0].apply(this, r, t.previousRenderSurface, !1), k.returnTexture(r);
            else {
                let o = t.inputTexture, d = k.getOptimalTexture(s.width, s.height, o.source._resolution, !1), c = 0;
            ...
            t.blendRequired && k.returnTexture(i);
        }
        getBackTexture(e, t, r) {
            const s = e.colorTexture.source._resolution, i = k.getOptimalTexture(t.width, t.height, s, !1);
            let n = t.minX, o = t.minY;
            r && (n -= r.minX, o -= r.minY), n = Math.floor(n * s), o = Math.floor(o * s);
            const d = Math.ceil(t.width * s), c = Math.ceil(t.height * s);
        ...
        applyFilter(e, t, r, s) {
            const i = this.renderer, n = this._filterStack[this._filterStackIndex], o = n.bounds, d = bt.shared, h = n.previousRenderSurface === r;
            ...
            const p = this._filterGlobalUniforms, u = p.uniforms, g = u.uOutputFrame, m = u.uInputSize, x = u.uInputPixel, b = u.uInputClamp, T = u.uGlobalFrame, S = u.uOutputTexture;
            if (h) {
            ...
            g[2] = t.frame.width, g[3] = t.frame.height, m[0] = t.source.width, m[1] = t.source.height, m[2] = 1 / m[0], m[3] = 1 / m[1], x[0] = t.source.pixelWidth, x[1] = t.source.pixelHeight, x[2] = 1 / x[0], x[3] = 1 / x[1], b[0] = .5 * x[2], b[1] = .5 * x[3], b[2] = t.frame.width * m[2] - .5 * x[2], b[3] = t.frame.height * m[3] - .5 * x[3];
            const C = this.renderer.renderTarget.rootRenderTarget.colorTexture;
            T[0] = d.x * l, T[1] = d.y * l, T[2] = C.source.width * l, T[3] = C.source.height * l;
            const F = this.renderer.renderTarget.getRenderTarget(r);
            if (i.renderTarget.bind(r, !!s), r instanceof P ? (S[0] = r.frame.width, S[1] = r.frame.height) : (S[0] = F.width, S[1] = F.height), S[2] = F.isRoot ? -1 : 1, p.update(), i.renderPipes.uniformBatch) {
                const B = i.renderPipes.uniformBatch.getUboResource(p);
            ...
            }), i.type === le.WEBGL && i.renderTarget.finishRenderPass();
        }
        _getFilterData() {
            return {
                skip: !1,
        ...
        calculateSpriteMatrix(e, t) {
            const r = this._activeFilterData, s = e.set(r.inputTexture._source.width, 0, 0, r.inputTexture._source.height, r.bounds.minX, r.bounds.minY), i = t.worldTransform.copyTo(M.shared), n = t.renderGroup || t.parentRenderGroup;
            return n && n.cacheToLocalTransform && i.prepend(n.cacheToLocalTransform), i.invert(), s.prepend(i), s.scale(1 / t.texture.frame.width, 1 / t.texture.frame.height), s.translate(t.anchor.x, t.anchor.y), s;
        }
    }
    Xe.extension = {
        type: [
    ...
    const je = class Ke extends de {
        constructor(...e){
            ...
            let s = t.uvs;
            s || (t.positions ? s = new Float32Array(r.length) : s = new Float32Array([
                0,
                0,
                1,
                0,
            ...
            const i = t.indices || new Uint32Array([
                0,
                1,
                2,
                0,
    ...
    function Yt(a) {
        ...
        return Xt(a.tagStyles, s), s.join(" ");
    }
    function Ne(a) {
        const e = R.shared.setValue(a.color).setAlpha(a.alpha).toHexa(), t = Math.round(Math.cos(a.angle) * a.distance), r = Math.round(Math.sin(a.angle) * a.distance), s = `${t}px ${r}px`;
    ...
    function Xt(a, e) {
        for(const t in a){
            const r = a[t], s = [];
            for(const i in r)ve[i] ? s.push(ve[i](r[i])) : ye[i] && s.push(ye[i].replace("{{VALUE}}", r[i]));
            e.push(`${t} { ${s.join(";")} }`);
        }
    }
    class fe extends I {
        ...
        get cssStyle() {
            return this._cssStyle || (this._cssStyle = Yt(this)), this._cssStyle;
        }
        addOverride(...e) {
        ...
        set fill(e) {
            typeof e != "string" && typeof e != "number" && W("[HTMLTextStyle] only color fill is not supported by HTMLText"), super.fill = e;
        }
        set stroke(e) {
            e && typeof e != "string" && typeof e != "number" && W("[HTMLTextStyle] only color stroke is not supported by HTMLText"), super.stroke = e;
        }
    }
    const Te = "http://www.w3.org/2000/svg", we = "http://www.w3.org/1999/xhtml";
    class Qe {
        constructor(){
            this.svgRoot = document.createElementNS(Te, "svg"), this.foreignObject = document.createElementNS(Te, "foreignObject"), this.domElement = document.createElementNS(we, "div"), this.styleElement = document.createElementNS(we, "style"), this.image = new Image;
    ...
    function jt(a, e, t, r) {
        ...
        s.innerHTML = `<style>${e.cssStyle};</style><div style='padding:0'>${a}</div>`, s.setAttribute("style", "transform-origin: top left; display: inline-block"), t && (i.textContent = t), document.body.appendChild(n);
    ...
    class Je {
        constructor(e, t){
            this.state = N.for2d(), this._graphicsBatchesHash = Object.create(null), this._destroyRenderableBound = this.destroyRenderable.bind(this), this.renderer = e, this._adaptor = t, this._adaptor.init(), this.renderer.renderableGC.addManagedHash(this, "_graphicsBatchesHash");
        }
        ...
        _initBatchesForRenderable(e) {
            const t = e.context, r = this.renderer.graphicsContext.getGpuContext(t), s = this.renderer._roundPixels | e._roundPixels, i = r.batches.map((n)=>{
                const o = v.get(vt);
                return n.copyTo(o), o.renderable = e, o.roundPixels = s, o;
            });
            return this._graphicsBatchesHash[e.uid] === void 0 && e.on("destroyed", this._destroyRenderableBound), this._graphicsBatchesHash[e.uid] = i, i;
        }
    ...
    const Ze = class et extends ue {
        ...
        build(e) {
            ...
            const t = this.verticesX * this.verticesY, r = [], s = [], i = [], n = this.verticesX - 1, o = this.verticesY - 1, d = this.width / n, c = this.height / o;
            for(let l = 0; l < t; l++){
                const f = l % this.verticesX, p = l / this.verticesX | 0;
                r.push(f * d, p * c), s.push(f / n, p / o);
            }
            const h = n * o;
            for(let l = 0; l < h; l++){
    ...
    class tt {
        ...
        validateRenderable(e) {
            ...
            if (s) {
                const i = e._geometry;
                if (i.indices.length !== t.indexSize || i.positions.length !== t.vertexSize) return t.indexSize = i.indices.length, t.vertexSize = i.positions.length, !0;
        ...
        destroy() {
            for(const e in this._gpuBatchableMeshHash)this._gpuBatchableMeshHash[e] && v.return(this._gpuBatchableMeshHash[e]);
    ...
    function Ce(a, e = null) {
        ...
        for(let r = 0, s = 0; r < t; r += 6, s += 4)e[r + 0] = s + 0, e[r + 1] = s + 1, e[r + 2] = s + 2, e[r + 3] = s + 0, e[r + 4] = s + 2, e[r + 5] = s + 3;
        return e;
    }
    function Qt(a) {
        return {
            dynamicUpdate: Be(a, !0),
            staticUpdate: Be(a, !1)
        };
    }
    function Be(a, e) {
...
`);
    ...
    class Jt {
        constructor(e){
            ...
            let s = 0, i = 0;
            for(const h in r){
                const l = r[h], f = ne(l.format);
                l.dynamic ? i += f.stride : s += f.stride;
            }
            this._dynamicStride = i / 4, this._staticStride = s / 4, this.staticAttributeBuffer = new $(t * 4 * s), this.dynamicAttributeBuffer = new $(t * 4 * i), this.indexBuffer = Ce(t);
            const n = new de;
            let o = 0, d = 0;
        ...
        update(e, t) {
            e.length > this._size && (t = !0, this._size = Math.max(e.length, this._size * 1.5 | 0), this.staticAttributeBuffer = new $(this._size * this._staticStride * 4 * 4), this.dynamicAttributeBuffer = new $(this._size * this._dynamicStride * 4 * 4), this.indexBuffer = Ce(this._size), this.geometry.indexBuffer.setDataWithSize(this.indexBuffer, this.indexBuffer.byteLength, !0));
            ...
            if (this._dynamicUpload(e, r.float32View, r.uint32View), this._dynamicBuffer.setDataWithSize(this.dynamicAttributeBuffer.float32View, e.length * this._dynamicStride * 4, !0), t) {
                ...
                this._staticUpload(e, s.float32View, s.uint32View), this._staticBuffer.setDataWithSize(s.float32View, e.length * this._staticStride * 4, !0);
            }
        }
        destroy() {
...
fn mainFragment(
  ...
  @builtin(position) position: vec4<f32>,
    ...
    class rt {
        constructor(e, t){
            this.state = N.for2d(), this._gpuBufferHash = Object.create(null), this._destroyRenderableBound = this.destroyRenderable.bind(this), this.localUniforms = new E({
                uTranslationMatrix: {
                    value: new M,
                    type: "mat3x3<f32>"
                },
            ...
            }), this.renderer = e, this.adaptor = t, this.defaultShader = new rr, this.state = N.for2d();
        }
        validateRenderable(e) {
            return !1;
        }
        ...
        _initBuffer(e) {
            return this._gpuBufferHash[e.uid] = new Jt({
        ...
        execute(e) {
            ...
            const i = this.state;
            s.update(t, e._childrenDirty), e._childrenDirty = !1, i.blendMode = ce(e.blendMode, e.texture._source);
    ...
    const nt = class at extends Kt {
        ...
        updatePositions() {
            const e = this.positions, { width: t, height: r, _leftWidth: s, _rightWidth: i, _topHeight: n, _bottomHeight: o, _anchorX: d, _anchorY: c } = this, h = s + i, l = t > h ? 1 : t / h, f = n + o, p = r > f ? 1 : r / f, u = Math.min(l, p), g = d * t, m = c * r;
            e[0] = e[8] = e[16] = e[24] = -g, e[2] = e[10] = e[18] = e[26] = s * u - g, e[4] = e[12] = e[20] = e[28] = t - i * u - g, e[6] = e[14] = e[22] = e[30] = t - g, e[1] = e[3] = e[5] = e[7] = -m, e[9] = e[11] = e[13] = e[15] = n * u - m, e[17] = e[19] = e[21] = e[23] = r - o * u - m, e[25] = e[27] = e[29] = e[31] = r - m, this.getBuffer("aPosition").update();
        }
        updateUvs() {
            const e = this.uvs;
    ...
    class ot {
        ...
        _initGPUSprite(e) {
            const t = v.get(pe);
            return t.geometry = v.get(sr), t.renderable = e, t.transform = e.groupTransform, t.texture = e._texture, t.roundPixels = this._renderer._roundPixels | e._roundPixels, this._gpuSpriteHash[e.uid] = t, e.didViewUpdate || this._updateBatchableSprite(e, t), e.on("destroyed", this._destroyRenderableBound), t;
        }
        destroy() {
    ...
    class ar extends he {
        ...
        updateUniforms(e, t, r, s, i, n) {
            ...
            l.set(r.a * d / e, r.b * d / t, r.c * c / e, r.d * c / t, r.tx / e, r.ty / t), l.invert(), o.uniforms.uMapCoord = h.mapCoord, o.uniforms.uClampFrame = h.uClampFrame, o.uniforms.uClampOffset = h.uClampOffset, o.uniforms.uTextureTransform = l, o.uniforms.uSizeAnchor[0] = e, o.uniforms.uSizeAnchor[1] = t, o.uniforms.uSizeAnchor[2] = s, o.uniforms.uSizeAnchor[3] = i, n && (this.resources.uTexture = n.source, this.resources.uSampler = n.source.style);
        }
    }
    class or extends ue {
        constructor(){
    ...
    function lr(a, e, t, r) {
        let s = 0;
        const i = a.length / e, n = r.a, o = r.b, d = r.c, c = r.d, h = r.tx, l = r.ty;
        for(t *= e; s < i;){
            const f = a[t], p = a[t + 1];
            a[t] = n * f + d * p + h, a[t + 1] = o * f + c * p + l, t += e, s++;
        }
    }
    function cr(a, e) {
        const t = a.texture, r = t.frame.width, s = t.frame.height;
        let i = 0, n = 0;
        a.applyAnchorToTexture && (i = a.anchor.x, n = a.anchor.y), e[0] = e[6] = -i, e[2] = e[4] = 1 - i, e[1] = e[3] = -n, e[5] = e[7] = 1 - n;
        const o = M.shared;
        o.copyFrom(a._tileTransform.matrix), o.tx /= a.width, o.ty /= a.height, o.invert(), o.scale(a.width / r, a.height / s), lr(e, 2, 0, o);
    }
    const X = new or;
    class dt {
        constructor(e){
            this._state = N.default2d, this._tilingSpriteDataHash = Object.create(null), this._destroyRenderableBound = this.destroyRenderable.bind(this), this._renderer = e, this._renderer.renderableGC.addManagedHash(this, "_tilingSpriteDataHash");
        }
        validateRenderable(e) {
        ...
        addRenderable(e, t) {
            ...
            if (n) {
                s.batchableMesh || (s.batchableMesh = new pe);
                const o = s.batchableMesh;
                e.didViewUpdate && (this._updateBatchableMesh(e), o.geometry = i, o.renderable = e, o.transform = e.groupTransform, o.setTexture(e._texture)), o.roundPixels = this._renderer._roundPixels | e._roundPixels, r.addToBatch(o, t);
            } else r.break(t), s.shader || (s.shader = new ar), this.updateRenderable(e), t.add(e);
        }
        execute(e) {
            ...
            r.uTransformMatrix = e.groupTransform, r.uRound = this._renderer._roundPixels | e._roundPixels, Q(e.groupColorAlpha, r.uColor, 0), this._state.blendMode = ce(e.groupBlendMode, e.texture._source), this._renderer.encoder.draw({
                geometry: X,
                shader: t,
                state: this._state
            });
        ...
        _updateBatchableMesh(e) {
            ...
            s.addressMode !== "repeat" && (s.addressMode = "repeat", s.update()), cr(e, r.uvs), dr(e, r.positions);
        }
        destroy() {
        ...
        _updateCanBatch(e) {
            ...
            let s = !0;
            return this._renderer.type === le.WEBGL && (s = this._renderer.context.supports.nonPowOf2wrapping), t.canBatch = r.textureMatrix.isSimple && (s || r.source.isPowerOfTwo), t.canBatch;
        }
    }
    dt.extension = {
        type: [
    ...
    class lt {
        ...
        addRenderable(e, t) {
            ...
            Re(e, r), e._didTextUpdate && (e._didTextUpdate = !1, this._updateContext(e, r)), this._renderer.renderPipes.graphics.addRenderable(r, t), r.context.customShader && this._updateDistanceField(e);
        }
        destroyRenderable(e) {
        ...
        updateRenderable(e) {
            const t = this._getGpuBitmapText(e);
            Re(e, t), this._renderer.renderPipes.graphics.updateRenderable(t), t.context.customShader && this._updateDistanceField(e);
        }
        _updateContext(e, t) {
            const { context: r } = t, s = Lt.getFont(e.text, e._style);
            r.clear(), s.distanceField.type !== "none" && (r.customShader || (r.customShader = v.get(gr)));
            const i = Array.from(e.text), n = e._style;
            ...
            const u = s.applyFillAsTint ? n._fill.color : 16777215;
            for(let g = 0; g < d.lines.length; g++){
                const m = d.lines[g];
                for(let x = 0; x < m.charPositions.length; x++){
                    const b = i[c++], T = s.chars[b];
                    T?.texture && r.texture(T.texture, u || "black", Math.round(m.charPositions[x] + T.xOffset), Math.round(o + T.yOffset));
                }
                o += s.lineHeight;
            }
        }
        ...
        _updateDistanceField(e) {
            const t = this._getGpuBitmapText(e).context, r = e._style.fontFamily, s = U.get(`${r}-bitmap`), { a: i, b: n, c: o, d } = e.groupTransform, c = Math.sqrt(i * i + n * n), h = Math.sqrt(o * o + d * d), l = (Math.abs(c) + Math.abs(h)) / 2, f = s.baseRenderedFontSize / e._style.fontSize, p = l * s.distanceField.range * (1 / f);
    ...
    class ct {
        ...
        async _updateGpuText(e) {
            ...
            const s = e.resolution ?? this._renderer.resolution, i = await this._renderer.htmlText.getManagedTexture(e.text, s, e._style, e._getKey()), n = t.batchableSprite;
            n.texture = t.texture = i, t.generatingTexture = !1, t.textureNeedsUploading = !0, e.onViewUpdate(), ae(n, e);
        }
        _getGpuText(e) {
    ...
    function ht(a, e, t, r) {
        const s = xr;
        s.minX = 0, s.minY = 0, s.maxX = a.width / r | 0, s.maxY = a.height / r | 0;
        const i = k.getOptimalTexture(s.width, s.height, r, !1);
        return i.source.uploadMethodId = "image", i.source.resource = a, i.source.alphaMode = "premultiply-alpha-on-upload", i.frame.width = e / r, i.frame.height = t / r, i.source.emit("update", i.source), i.updateUvs(), i;
    }
    function _r(a, e) {
        const t = e.fontFamily, r = [], s = {}, i = /font-family:([^;"\s]+)/g, n = a.match(i);
        function o(d) {
            s[d] || (r.push(d), s[d] = !0);
        }
    ...
    const j = new Map;
    async function yr(a, e, t) {
        const r = a.filter((s)=>U.has(`${s}-and-url`)).map((s, i)=>{
            if (!j.has(s)) {
                const { url: n } = U.get(`${s}-and-url`);
                i === 0 ? j.set(s, Me({
...
`);
    ...
    function vr(a, e, t, r, s) {
        const { domElement: i, styleElement: n, svgRoot: o } = s;
        i.innerHTML = `<style>${e.cssStyle}</style><div style='padding:0;'>${a}</div>`, i.setAttribute("style", `transform: scale(${t});transform-origin: top left; display: inline-block`), n.textContent = r;
        const { width: d, height: c } = s.image;
        return o.setAttribute("width", d.toString()), o.setAttribute("height", c.toString()), new XMLSerializer().serializeToString(o);
    }
    function Tr(a, e) {
        const t = O.getOptimalCanvasAndContext(a.width, a.height, e), { context: r } = t;
        return r.clearRect(0, 0, a.width, a.height), r.drawImage(a, 0, 0), t;
    }
    function wr(a, e, t) {
        return new Promise(async (r)=>{
            t && await new Promise((s)=>setTimeout(s, 100)), a.onload = ()=>{
                r();
    ...
    class ge {
        ...
        getManagedTexture(e, t, r, s) {
            ...
            const i = this._buildTexturePromise(e, t, r).then((n)=>(this._activeTextures[s].texture = n, n));
        ...
        async _buildTexturePromise(e, t, r) {
            const s = v.get(Qe), i = _r(e, r), n = await yr(i, r, fe.defaultTextStyle), o = jt(e, r, n, s), d = Math.ceil(Math.ceil(Math.max(1, o.width) + r.padding * 2) * t), c = Math.ceil(Math.ceil(Math.max(1, o.height) + r.padding * 2) * t), h = s.image, l = 2;
            h.width = (d | 0) + l, h.height = (c | 0) + l;
            const f = vr(e, r, t, n, s);
            await wr(h, f, mr() && i.length > 0);
            const p = h;
            let u;
            this._createCanvas && (u = Tr(h, t));
            const g = ht(u ? u.canvas : p, h.width - l, h.height - l, t);
            return this._createCanvas && (this._renderer.texture.initSource(g.source), O.returnCanvasAndContext(u)), v.return(s), g;
        }
        ...
        decreaseReferenceCount(e) {
            ...
            t && (t.usageCount--, t.usageCount === 0 && (t.texture ? this._cleanUp(t) : t.promise.then((r)=>{
                ...
                W("HTMLTextSystem: Failed to clean texture");
    ...
    class ut {
        ...
        _updateText(e) {
            const t = e._getKey(), r = this._getGpuText(e), s = r.batchableSprite;
            r.currentKey !== t && this._updateGpuText(e), e._didTextUpdate = !1, ae(s, e);
        }
        _updateGpuText(e) {
    ...
    function Fe(a, e, t) {
        for(let r = 0, s = 4 * t * e; r < e; ++r, s += 4)if (a[s + 3] !== 0) return !1;
        return !0;
    }
    function Ue(a, e, t, r, s) {
        const i = 4 * e;
        for(let n = r, o = r * i + 4 * t; n <= s; ++n, o += i)if (a[o + 3] !== 0) return !1;
        return !0;
    }
    function Sr(a, e = 1) {
        const { width: t, height: r } = a, s = a.getContext("2d", {
    ...
    class ft {
        ...
        getTextureSize(e, t, r) {
            const s = D.measureText(e || " ", r);
            let i = Math.ceil(Math.ceil(Math.max(1, s.width) + r.padding * 2) * t), n = Math.ceil(Math.ceil(Math.max(1, s.height) + r.padding * 2) * t);
            return i = Math.ceil(i - 1e-6), n = Math.ceil(n - 1e-6), i = K(i), n = K(n), {
                width: i,
                height: n
            };
        }
        getTexture(e, t, r, s) {
            ...
            return this._renderer.texture.initSource(i._source), O.returnCanvasAndContext(n), i;
        }
        createTextureAndCanvas(e) {
            const { text: t, style: r } = e, s = e.resolution ?? this._renderer.resolution, i = D.measureText(t || " ", r), n = Math.ceil(Math.ceil(Math.max(1, i.width) + r.padding * 2) * s), o = Math.ceil(Math.ceil(Math.max(1, i.height) + r.padding * 2) * s), d = O.getOptimalCanvasAndContext(n, o), { canvas: c } = d;
        ...
        renderTextToCanvas(e, t, r, s) {
            const { canvas: i, context: n } = s, o = se(t), d = D.measureText(e || " ", t), c = d.lines, h = d.lineHeight, l = d.lineWidths, f = d.maxLineWidth, p = d.fontProperties, u = i.height;
            ...
            for(let b = 0; b < x; ++b){
                const T = t.dropShadow && b === 0, S = T ? Math.ceil(Math.max(1, u) + t.padding * 2) : 0, C = S * r;
                if (T) {
                    ...
                    const J = y.blur * r, me = y.distance * r;
                    n.shadowBlur = J, n.shadowOffsetX = Math.cos(y.angle) * me, n.shadowOffsetY = Math.sin(y.angle) * me + C;
                } else {
                    if (n.fillStyle = t._fill ? q(t._fill, n, d) : null, t._stroke?.width) {
                        const y = t._stroke.width * t._stroke.alignment;
                        n.strokeStyle = q(t._stroke, n, d, y);
                    }
                    n.shadowColor = "black";
                }
                ...
                for(let y = 0; y < c.length; y++)g = B / 2, m = B / 2 + y * h + p.ascent + F, t.align === "right" ? g += f - l[y] : t.align === "center" && (g += (f - l[y]) / 2), t._stroke?.width && this._drawLetterSpacing(c[y], t, s, g + t.padding, m + t.padding - S, !0), t._fill !== void 0 && this._drawLetterSpacing(c[y], t, s, g + t.padding, m + t.padding - S);
            }
        }
        _drawLetterSpacing(e, t, r, s, i, n = !1) {
            ...
            for(let u = 0; u < l.length; ++u){
                const g = l[u];
                n ? o.strokeText(g, h, i) : o.fillText(g, h, i);
                let m = "";
