import { E as d, B as T, w as m, D as S, K as j, u as Te, s as G, t as b, a1 as Be, j as K, S as p, O as L, i as B, h as A, k as U, q as $, M as z, a2 as Y, a3 as Ae, a4 as Ne, a5 as q, a6 as ye, A as De, R as Ce, e as x, __tla as __tla_0 } from "./index-DHMh91wP.js";
import { S as F, b as Z } from "./colorToUniform-C2GHuDhf.js";
import { e as Ie, G as Ge, c as Ue, b as Fe, U as Oe, R as Pe, B as Q, d as N, f as Me, S as Le, a as He, __tla as __tla_1 } from "./SharedSystems-EnuYue6P.js";
let Ft;
let __tla = Promise.all([
    ...
    const O = class te {
        ...
        init(e) {
            ...
            if (e.context && r && (m("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."), r = !1), r ? this.canvas = S.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this.canvas = this._renderer.view.canvas, e.context) this.initFromContext(e.context);
            else {
    ...
    class se {
        ...
        contextChange() {
            ...
            }, e.vertexAttribDivisor = (n, i)=>s.vertexAttribDivisorANGLE(n, i)), this._activeGeometry = null, this._activeVao = null, this._geometryVaoHash = Object.create(null);
        }
        bind(e, r) {
            const s = this.gl;
        ...
        activateVao(e, r) {
            ...
            for(const o in i){
                ...
                if (h) {
                    ...
                    if (h.format?.substring(1, 4) === "int" ? s.vertexAttribIPointer(l, E.size, M, c.stride, c.offset) : s.vertexAttribPointer(l, E.size, M, E.normalised, c.stride, c.offset), c.instance) if (this.hasInstance) {
...
`);
    ...
    class le {
        ...
        contextChange(e) {
            this._gl = e, this._programDataHash = Object.create(null), this._shaderSyncFunctions = Object.create(null), this._activeProgram = null, this.maxTextures = $();
        }
        bind(e, r) {
...
`));
    ...
    class be {
        ...
        _initSampler(e) {
            ...
            return this._glSamplers[e._resourceId] = s, W(e, r, this._boundTextures[this._activeTextureLocation].mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "samplerParameteri", s, !1, !0), this._glSamplers[e._resourceId];
        }
        _getGlSampler(e) {
        ...
        resetState() {
            this._activeTextureLocation = -1, this._boundTextures.fill(b.EMPTY.source), this._boundSamplers = Object.create(null);
            const e = this._gl;
...
export { Ft as WebGLRenderer, __tla };
