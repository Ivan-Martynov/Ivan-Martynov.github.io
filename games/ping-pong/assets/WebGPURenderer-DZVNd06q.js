import { g as R, E as f, f as oe, D as T, S as C, B as P, b as ae, c as E, d as U, w as A, h as y, i as ue, j as ce, k as L, M as k, l as D, m as de, o as he, p as H, q as pe, s as z, t as M, A as le, R as fe, e as B, __tla as __tla_0 } from "./index-DHMh91wP.js";
import { S as F, l as ge, a as me } from "./colorToUniform-C2GHuDhf.js";
import { c as _e, u as be, U as ye, B as xe, G as Ge, e as Be, R as Se, t as Pe, S as Te, a as Ce, __tla as __tla_1 } from "./SharedSystems-EnuYue6P.js";
import { C as w, __tla as __tla_2 } from "./CanvasPool-C6zJL_60.js";
let Ye;
let __tla = Promise.all([
    ...
    class O {
        start(e, t, r) {
            ...
            this._shader = r, this._geometry = t, i.setGeometry(t, n), x.blendMode = "normal", s.pipeline.getPipeline(t, n, x);
        ...
        execute(e, t) {
            ...
            const n = s.bindGroup.getBindGroup(t.bindGroup, r, 1), o = s.pipeline.getPipeline(this._geometry, r, x, t.topology);
    ...
    class N {
        ...
        restoreRenderPass() {
            const e = this._renderer.renderTarget.adaptor.getDescriptor(this._renderer.renderTarget.renderTarget, !1, [
                0,
                0,
                0,
                1
    ...
    class q {
        constructor(e){
            this._bindGroupHash = Object.create(null), this._buffers = [], this._bindGroups = [], this._bufferResources = [], this._renderer = e, this._renderer.renderableGC.addManagedHash(this, "_bindGroupHash"), this._batchBuffer = new ve({
    ...
    class Y {
        ...
        getBufferNamesToBind(e, t) {
            ...
            const s = this._createVertexBufferLayouts(e, t), i = Object.create(null), n = t.attributeData;
            for(let o = 0; o < s.length; o++){
                const c = Object.values(s[o].attributes)[0].shaderLocation;
                for(const p in n)if (n[p].location === c) {
                    i[o] = p;
                    break;
                }
            }
        ...
        _updatePipeHash() {
            const e = Ae(this._stencilMode, this._multisampleCount, this._colorMask, this._depthStencilAttachment);
    ...
    class ke {
        ...
        getDescriptor(e, t, r) {
            ...
            const s = this._renderTargetSystem, i = s.getGpuRenderTarget(e), n = e.colorTextures.map((c, p)=>{
                const h = i.contexts[p];
                let l, d;
                h ? l = h.getCurrentTexture().createView() : l = this._renderer.texture.getGpuSource(c).createView({
                    mipLevelCount: 1
                }), i.msaaTextures[p] && (d = l, l = this._renderer.texture.getTextureView(i.msaaTextures[p]));
        ...
        execute(e, t) {
            ...
            for(let _ = 0; _ < u.instructionSize; _++){
                ...
                if (m.topology !== d && (d = m.topology, c.setPipelineFromGeometryProgramAndState(o.geometry, s.gpuProgram, e.state, m.topology)), s.groups[1] = m.bindGroup, !m.gpuBindGroup) {
                    const S = m.textures;
                    m.bindGroup = R(S.textures, S.count), m.gpuBindGroup = i.bindGroup.getBindGroup(m.bindGroup, s.gpuProgram, 1);
                }
...
export { Ye as WebGPURenderer, __tla };
