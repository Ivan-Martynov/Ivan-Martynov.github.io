import { s as Le, G as te, u as re, E as l, v as We, k as se, M as v, x as ae, e as O, y as g, z as ze, F, H as y, R as H, I as ne, J as Ve, t as m, S as f, h as B, w as ie, K, L as Ne, b as Y, B as C, i as U, N as M, j as T, O as w, Q as je, a as $e, V as oe, W as le, X as ue, Y as de, C as P, Z as ce, _ as qe, P as Ke, c as Ye, T as J, D as he, $ as Je, a0 as Xe, __tla as __tla_0 } from "./index-DHMh91wP.js";
import { S as fe, B as pe, c as Qe } from "./colorToUniform-C2GHuDhf.js";
let Ot, x, Dt, Ft, At, Ht, it, Gt, S, It, Ut, Bt, Et;
    ...
    const me = class I extends Le {
        constructor(e){
            e = {
                ...I.defaultOptions,
                ...e
            }, super(e), this.enabled = !0, this._state = fe.for2d(), this.blendMode = e.blendMode, this.padding = e.padding, typeof e.antialias == "boolean" ? this.antialias = e.antialias ? "on" : "off" : this.antialias = e.antialias, this.resolution = e.resolution, this.blendRequired = e.blendRequired, this.clipToViewport = e.clipToViewport, this.addResource("uTexture", 0, 1);
        }
        apply(e, t, r, s) {
...
`;
    ...
    const L = class ge {
        constructor(e, t){
            this.state = fe.for2d(), this._batchersByInstructionSet = Object.create(null), this._activeBatches = Object.create(null), this.renderer = e, this._adaptor = t, this._adaptor.init?.(this);
        }
        static getBatcher(e) {
        ...
        buildStart(e) {
            ...
            t || (t = this._batchersByInstructionSet[e.uid] = Object.create(null), t.default || (t.default = new ae)), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
    ...
    let _e = L;
    O.handleByMap(l.Batcher, _e._availableBatchers);
    O.add(ae);
    let st;
    Bt = {
        name: "texture-bit",
        ...
        execute(e) {
            ...
            if (e.action === "pushMaskBegin") {
                ...
                if (s.inverse = e.inverse, r) {
                    ...
                    const i = t.renderTarget.renderTarget.colorTexture.source, o = y.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
                    t.renderTarget.push(o, !0), t.globalUniforms.push({
                        offset: n,
                        worldColor: 4294967295
                    });
                    const u = s.sprite;
                    u.texture = o, u.worldTransform.tx = n.minX, u.worldTransform.ty = n.minY, this._activeMaskStage.push({
                        filterEffect: s,
    ...
    class ye {
        ...
        push(e, t, r) {
            ...
            const u = this._maskHash.get(n);
            u.instructionsStart = r.instructionSize, o.collectRenderables(r, i, null), o.includeInBuild = !1, i.renderPipes.batch.break(r), r.add({
                renderPipeId: "stencilMask",
                action: "pushMaskEnd",
                mask: e,
                inverse: t._maskOptions.inverse,
    ...
    At = class {
        ...
        _systemCheck() {
            if (!Ne()) throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.");
        }
    ...
    `
        ...
        for(let o = 0; o < a.length; o++){
            const u = a[o], d = u.data.name;
            let c = !1, h = 0;
            for(let p = 0; p < S.length; p++)if (S[p].test(u.data)) {
                h = u.offset / 4, s.push(`name = "${d}";`, `offset += ${h - n};`, S[p][e] || S[p].ubo), c = !0;
                break;
            }
            if (!c) if (u.data.size > 1) h = u.offset / 4, s.push(t(u, h - n));
            else {
                const p = r[u.data.type];
                h = u.offset / 4, s.push(`
                    v = uv.${d};
                    offset += ${h - n};
                    ${p};
...
`);
    ...
    const ke = class Ce {
        constructor(e = {}){
            if (this.uid = M("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = !1, this._size = new Float32Array(2), this._managedColorTextures = !1, e = {
                ...Ce.defaultOptions,
                ...e
    ...
    Dt = class {
        constructor(e){
            this.rootViewPort = new w, this.viewport = new w, this.onRenderTargetChange = new je("onRenderTargetChange"), this.projectionMatrix = new v, this.defaultClearColor = [
                0,
                0,
                0,
                0
        ...
        renderStart({ target: e, clear: t, clearColor: r, frame: s }) {
            this._renderTargetStack.length = 0, this.push(e, t, r, s), this.rootViewPort.copyFrom(this.viewport), this.rootRenderTarget = this.renderTarget, this.renderingToScreen = lt(this.rootRenderTarget), this.adaptor.prerender?.(this.rootRenderTarget);
        }
        postrender() {
        ...
        bind(e, t = !0, r, s) {
            ...
            const u = n.colorTexture, d = this.viewport, c = u.pixelWidth, h = u.pixelHeight;
            if (!s && e instanceof m && (s = e.frame), s) {
                const p = u._resolution;
                d.x = s.x * p + .5 | 0, d.y = s.y * p + .5 | 0, d.width = s.width * p + .5 | 0, d.height = s.height * p + .5 | 0;
            } else d.x = 0, d.y = 0, d.width = c, d.height = h;
            return ot(this.projectionMatrix, 0, 0, d.width / u.resolution, d.height / u.resolution, !n.isRoot), this.adaptor.startRenderPass(n, t, r, d), i && this.onRenderTargetChange.emit(n), n;
        }
        clear(e, t = B.ALL, r) {
    ...
    function we(a, e = !1) {
        ...
        for(const s in t){
            const n = Number(s), i = t[s], o = i.list, u = i.index;
            for(let d = 0; d < u; d++){
                const c = o[d];
        ...
        if (e) for(let s = 0; s < a.renderGroupChildren.length; s++)we(a.renderGroupChildren[s], e);
    }
    function ct(a) {
        const e = a.root;
        let t;
    ...
    function Pe(a, e, t) {
        ...
        const s = a.parent;
        if (s && !s.renderGroup ? (t |= a._updateFlags, a.relativeGroupTransform.appendFrom(r, s.relativeGroupTransform), t & Q && Z(a, s, t)) : (t = a._updateFlags, a.relativeGroupTransform.copyFrom(r), t & Q && Z(a, dt, t)), !a.renderGroup) {
            const n = a.children, i = n.length;
            for(let d = 0; d < i; d++)Pe(n[d], e, t);
            const o = a.parentRenderGroup, u = a;
        ...
        _updateCachedRenderGroups(e, t) {
            ...
            if (e.invalidateMatrices(), e.isCachedAsTexture) {
                if (e.textureNeedsUpdate) {
                    ...
                    e.texture = y.getOptimalTexture(r.width, r.height, i, o), e._textureBounds || (e._textureBounds = new F), e._textureBounds.copyFrom(r), s !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = !0);
                }
    ...
    class Be {
        ...
        destroy() {
            for(const e in this._gpuSpriteHash)g.return(this._gpuSpriteHash[e]);
    ...
    class Ie {
        ...
        _beginAdvancedBlendMode(e) {
            ...
            r || (r = this._filterHash[t] = new ne, r.filters = [
                new k[t]
            ]);
            const s = {
                renderPipeId: "filter",
        ...
        async base64(e) {
            ...
            if (s.toBlob !== void 0) return new Promise((n, i)=>{
                s.toBlob((o)=>{
                    ...
                    u.onload = ()=>n(u.result), u.onerror = i, u.readAsDataURL(o);
                }, R[t], r);
            });
            ...
            if (s.convertToBlob !== void 0) {
                ...
                return new Promise((i, o)=>{
                    const u = new FileReader;
                    u.onload = ()=>i(u.result), u.onerror = o, u.readAsDataURL(n);
                });
            }
    ...
    class Ge {
        ...
        generateTexture(e) {
            ...
            const i = e.frame?.copyTo(vt) || qe(s, gt).rectangle;
    ...
    class Ee {
        ...
        bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: n }) {
            ...
            const c = d.uniforms;
            c.uProjectionMatrix = u.projectionMatrix, c.uResolution = u.resolution, c.uWorldTransformMatrix.copyFrom(u.worldTransformMatrix), c.uWorldTransformMatrix.tx -= u.offset.x, c.uWorldTransformMatrix.ty -= u.offset.y, Qe(u.worldColor, c.uWorldColorAlpha, 0), d.update();
            let h;
            this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(d, !1) : (h = this._bindGroupPool.pop() || new Ye, this._activeBindGroups.push(h), h.setResource(d, 0)), u.bindGroup = h, this._currentGlobalUniformData = u;
        }
        push(e) {
    ...
    const j = class Oe {
        ...
        set enabled(e) {
            this.enabled !== e && (e ? (this._handler = this._renderer.scheduler.repeat(()=>this.run(), this._frequency, !1), this._hashHandler = this._renderer.scheduler.repeat(()=>{
                ...
                for (const t of this._managedArrays)Tt(t.context[t.hash]);
        ...
        run() {
            ...
            for(let n = 0; n < t.length; n++){
                ...
                const o = i.renderGroup ?? i.parentRenderGroup, u = o?.instructionSet?.gcTick ?? -1;
                if ((o?.gcTick ?? 0) === u && (i._lastUsed = e), e - i._lastUsed > this.maxUnusedTime) {
                    if (!i.destroyed) {
                        const d = r;
...
export { Ot as B, x as G, Dt as R, Ft as S, At as U, Ht as a, it as b, Gt as c, S as d, It as e, Ut as f, Bt as t, Et as u, __tla };
