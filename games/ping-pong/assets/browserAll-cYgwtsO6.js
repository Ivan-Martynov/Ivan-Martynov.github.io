import { P as f, r as Q, E as _, T as C, U as ee, a as te, w as g, e as P, C as Z, __tla as __tla_0 } from "./index-DHMh91wP.js";
import { __tla as __tla_1 } from "./webworkerAll-otWi4UGs.js";
import "./colorToUniform-C2GHuDhf.js";
import { __tla as __tla_2 } from "./CanvasPool-C6zJL_60.js";
Promise.all([
    (()=>{
        try {
            return __tla_0;
    ...
    class q {
        ...
        postrender() {
            ...
            this._domElement.parentNode !== t.parentNode && t.parentNode?.appendChild(this._domElement), this._domElement.style.transform = `translate(${t.offsetLeft}px, ${t.offsetTop}px)`;
    ...
    class me {
            ...
            if ((e.eventMode === "dynamic" || t === "dynamic") && (y.pauseUpdate = !1), e.interactiveChildren && e.children) {
                ...
                for(let m = h.length - 1; m >= 0; m--){
                    ...
                    if (p) {
                        ...
                        (p.length > 0 || O) && (O && this._allInteractiveElements.push(e), p.push(e)), this._hitElements.length === 0 && (this._hitElements = p), r = !0;
                    }
                }
            }
        ...
        _notifyListeners(e, t) {
            ...
            else for(let n = 0, s = i.length; n < s && !e.propagationImmediatelyStopped; n++)i[n].once && e.currentTarget.removeListener(t, i[n].fn, void 0, !0), i[n].fn.call(i[n].context, e);
        }
    }
    const ge = 1, ye = {
        ...
        constructor(e){
            this.supportsTouchEvents = "ontouchstart" in globalThis, this.supportsPointerEvents = !!globalThis.PointerEvent, this.domElement = null, this.resolution = 1, this.renderer = e, this.rootBoundary = new me(null), y.init(this), this.autoPreventDefault = !0, this._eventsAdded = !1, this._rootPointerEvent = new u(null), this._rootWheelEvent = new E(null), this.cursorStyles = {
                default: "inherit",
                pointer: "pointer"
        ...
        _normalizeToPointerData(e) {
            ...
            if (this.supportsTouchEvents && e instanceof TouchEvent) for(let i = 0, n = e.changedTouches.length; i < n; i++){
                ...
                typeof s.button > "u" && (s.button = 0), typeof s.buttons > "u" && (s.buttons = 1), typeof s.isPrimary > "u" && (s.isPrimary = e.touches.length === 1 && e.type === "touchstart"), typeof s.width > "u" && (s.width = s.radiusX || 1), typeof s.height > "u" && (s.height = s.radiusY || 1), typeof s.tiltX > "u" && (s.tiltX = 0), typeof s.tiltY > "u" && (s.tiltY = 0), typeof s.pointerType > "u" && (s.pointerType = "touch"), typeof s.pointerId > "u" && (s.pointerId = s.identifier || 0), typeof s.pressure > "u" && (s.pressure = s.force || .5), typeof s.twist > "u" && (s.twist = 0), typeof s.tangentialPressure > "u" && (s.tangentialPressure = 0), typeof s.layerX > "u" && (s.layerX = s.offsetX = s.clientX), typeof s.layerY > "u" && (s.layerY = s.offsetY = s.clientY), s.isNormalized = !0, s.type = e.type, t.push(s);
            }
