import { E as _, U as pt, T as ge, a as gt, $ as G, a0 as z, t as P, Z as R, M, a7 as mt, a8 as xt, w as O, a9 as re, aa as W, O as ie, ab as _t, ac as I, ad as U, k as E, c as Ue, H as k, P as bt, a1 as ae, R as oe, F as ke, b as L, B as A, ae as yt, y as T, af as Tt, ag as de, K as se, ah as $, s as le, u as vt, G as wt, ai as St, l as Ae, p as Ge, a2 as ze, a5 as He, q as Ct, m as Bt, o as Pt, a3 as Rt, a4 as Mt, a6 as Ft, aj as Ut, ak as kt, D as We, n as me, e as w, al as At, __tla as __tla_0 } from "./index-DHMh91wP.js";
import { S as K, c as q, a as Gt, b as zt, B as De } from "./colorToUniform-C2GHuDhf.js";
import { C as D, __tla as __tla_1 } from "./CanvasPool-C6zJL_60.js";
    ...
    const Le = class Ve extends Ht {
        ...
        ensureCharacters(e) {
            ...
            for(let m = 0; m < t.length; m++){
                const x = t[m], b = W.measureText(x, o, i, !1);
...
` && x !== "\r" && x !== "	" && x !== " " && (p = !0, f = Math.ceil(Math.max(B, f))), d + F > u && (c += f, f = B, d = 0, c + f > g)) {
                ...
                const y = v / h - (o.dropShadow?.distance ?? 0) - (o._stroke?.width ?? 0);
                if (this.chars[x] = {
                    id: x.codePointAt(0),
        ...
        _drawGlyph(e, t, r, i, s, n) {
            const o = t.text, d = t.fontProperties, h = (n._stroke?.width ?? 0) * s, l = r + h / 2, f = i - h / 2, p = d.descent * s, u = t.lineHeight * s;
    ...
    function $e(a, e, t, r) {
        ...
        const d = {
            ...
            s.width += u.width, o = !1, d.width = 0, d.index = 0, d.chars.length = 0;
        }, h = ()=>{
...
`) s.width !== 0 && h();
    ...
    class Xe {
        ...
        push(e) {
            ...
            const s = i.bounds;
            if (e.renderables ? Lt(e.renderables, s) : e.filterEffect.filterArea ? (s.clear(), s.addRect(e.filterEffect.filterArea), s.applyMatrix(e.container.worldTransform)) : e.container.getFastGlobalBounds(!0, s), e.container) {
            ...
            for(let p = 0; p < r.length; p++){
                ...
                if (u.blendRequired && !(t.backBuffer?.useBackBuffer ?? !0)) {
                    O("Blend filter requires backBuffer on WebGL renderer to be enabled. Set `useBackBuffer: true` in the renderer options."), l = !1;
                    break;
                }
            ...
            i.skip = !1, i.bounds = s, i.blendRequired = h, i.container = e.container, i.filterEffect = e.filterEffect, i.previousRenderSurface = t.renderTarget.renderSurface, i.inputTexture = k.getOptimalTexture(s.width, s.height, o, c), t.renderTarget.bind(i.inputTexture, !0), t.globalUniforms.push({
                offset: s
            });
        }
        pop() {
            ...
            if (this._globalFilterBindGroup.setResource(r.source.style, 2), this._globalFilterBindGroup.setResource(s.source, 3), e.globalUniforms.pop(), n.length === 1) n[0].apply(this, r, t.previousRenderSurface, !1), k.returnTexture(r);
            else {
                let o = t.inputTexture, d = k.getOptimalTexture(i.width, i.height, o.source._resolution, !1), c = 0;
        ...
        getBackTexture(e, t, r) {
            const i = e.colorTexture.source._resolution, s = k.getOptimalTexture(t.width, t.height, i, !1);
    ...
    class Je {
        constructor(e, t){
            this.state = K.for2d(), this._graphicsBatchesHash = Object.create(null), this._destroyRenderableBound = this.destroyRenderable.bind(this), this.renderer = e, this._adaptor = t, this._adaptor.init(), this.renderer.renderableGC.addManagedHash(this, "_graphicsBatchesHash");
        }
    ...
    class tt {
        ...
        validateRenderable(e) {
            ...
            if (i) {
                const s = e._geometry;
                if (s.indices.length !== t.indexSize || s.positions.length !== t.vertexSize) return t.indexSize = s.indices.length, t.vertexSize = s.positions.length, !0;
...
`);
    ...
    class Qt {
        ...
        update(e, t) {
            e.length > this._size && (t = !0, this._size = Math.max(e.length, this._size * 1.5 | 0), this.staticAttributeBuffer = new $(this._size * this._staticStride * 4 * 4), this.dynamicAttributeBuffer = new $(this._size * this._dynamicStride * 4 * 4), this.indexBuffer = Se(this._size), this.geometry.indexBuffer.setDataWithSize(this.indexBuffer, this.indexBuffer.byteLength, !0));
...
fn mainFragment(
  ...
  @builtin(position) position: vec4<f32>,
    ...
    class rt {
        constructor(e, t){
            this.state = K.for2d(), this._gpuBufferHash = Object.create(null), this._destroyRenderableBound = this.destroyRenderable.bind(this), this.localUniforms = new E({
                uTranslationMatrix: {
                    value: new M,
                    type: "mat3x3<f32>"
                },
        ...
        execute(e) {
            ...
            const s = this.state;
            i.update(t, e._childrenDirty), e._childrenDirty = !1, s.blendMode = de(e.blendMode, e.texture._source);
    ...
    class dt {
        constructor(e){
            this._state = K.default2d, this._tilingSpriteDataHash = Object.create(null), this._destroyRenderableBound = this.destroyRenderable.bind(this), this._renderer = e, this._renderer.renderableGC.addManagedHash(this, "_tilingSpriteDataHash");
        }
        validateRenderable(e) {
    ...
    class lt {
        ...
        addRenderable(e, t) {
            ...
            Pe(e, r), e._didTextUpdate && (e._didTextUpdate = !1, this._updateContext(e, r)), this._renderer.renderPipes.graphics.addRenderable(r, t), r.context.customShader && this._updateDistanceField(e);
        }
        destroyRenderable(e) {
        ...
        _updateContext(e, t) {
            ...
            for(let g = 0; g < d.lines.length; g++){
                ...
                for(let x = 0; x < m.charPositions.length; x++){
                    ...
                    v?.texture && r.texture(v.texture, u || "black", Math.round(m.charPositions[x] + v.xOffset), Math.round(o + v.yOffset));
                }
                o += i.lineHeight;
            }
        }
    ...
    class ct {
        ...
        async _updateGpuText(e) {
            ...
            n.texture = t.texture = s, t.generatingTexture = !1, t.textureNeedsUploading = !0, e.onViewUpdate(), ne(n, e);
        }
        _getGpuText(e) {
    ...
    function ht(a, e, t, r) {
        ...
        const s = k.getOptimalTexture(i.width, i.height, r, !1);
...
`);
    ...
    class ut {
        ...
        _updateText(e) {
            const t = e._getKey(), r = this._getGpuText(e), i = r.batchableSprite;
            r.currentKey !== t && this._updateGpuText(e), e._didTextUpdate = !1, ne(i, e);
        }
        _updateGpuText(e) {
        ...
        renderTextToCanvas(e, t, r, i) {
            ...
            for(let b = 0; b < x; ++b){
                ...
                if (v) {
                    ...
                    if (n.fillStyle = t._fill ? N(t._fill, n, d) : null, t._stroke?.width) {
                ...
                for(let y = 0; y < c.length; y++)g = B / 2, m = B / 2 + y * h + p.ascent + F, t.align === "right" ? g += f - l[y] : t.align === "center" && (g += (f - l[y]) / 2), t._stroke?.width && this._drawLetterSpacing(c[y], t, i, g + t.padding, m + t.padding - S, !0), t._fill !== void 0 && this._drawLetterSpacing(c[y], t, i, g + t.padding, m + t.padding - S);
            }
        }
        _drawLetterSpacing(e, t, r, i, s, n = !1) {
            const { context: o } = r, d = t.letterSpacing;
            let c = !1;
            if (W.experimentalLetterSpacingSupported && (W.experimentalLetterSpacing ? (o.letterSpacing = `${d}px`, o.textLetterSpacing = `${d}px`, c = !0) : (o.letterSpacing = "0px", o.textLetterSpacing = "0px")), d === 0 || c) {
